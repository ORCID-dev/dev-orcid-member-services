...
public class Assertion implements Serializable {
      ...
      public int hashCode() {
            ...
            result =
                  ...
                  result +
                  (
                        (affiliationSection == null)
                              ? 0
                              : affiliationSection.hashCode()
                  );
            result =
                  prime * result + ((created == null) ? 0 : created.hashCode());
            result =
                  prime *
                  result +
            ...
            result =
                  ...
                  result +
                  (
                        (disambiguatedOrgId == null)
                              ? 0
                              : disambiguatedOrgId.hashCode()
                  );
            result =
                  prime *
                  result +
            ...
            result =
                  prime * result + ((endDay == null) ? 0 : endDay.hashCode());
            result =
                  prime *
                  result +
                  ((endMonth == null) ? 0 : endMonth.hashCode());
            result =
                  prime * result + ((endYear == null) ? 0 : endYear.hashCode());
            result =
                  prime *
                  result +
            ...
            result =
                  prime *
                  result +
                  ((orcidError == null) ? 0 : orcidError.hashCode());
            result =
                  prime * result + ((orgCity == null) ? 0 : orgCity.hashCode());
            result =
                  prime *
                  result +
                  ((orgCountry == null) ? 0 : orgCountry.hashCode());
            result =
                  prime * result + ((orgName == null) ? 0 : orgName.hashCode());
            result =
                  prime *
                  result +
                  ((orgRegion == null) ? 0 : orgRegion.hashCode());
            result =
                  prime * result + ((ownerId == null) ? 0 : ownerId.hashCode());
            result =
                  prime * result + ((putCode == null) ? 0 : putCode.hashCode());
            result =
                  prime *
                  result +
                  ((roleTitle == null) ? 0 : roleTitle.hashCode());
            result =
                  prime *
                  result +
            ...
            result =
                  prime * result + ((orcidId == null) ? 0 : orcidId.hashCode());
            result =
                  prime *
                  result +
                  (
      ...
      public boolean equals(Object obj) {
            ...
            if (externalIdType == null) {
                  ...
                  !externalIdType.equals(other.externalIdType)
            ) return false;
            ...
            if (lastSyncAttempt == null) {
                  ...
                  !lastSyncAttempt.equals(other.lastSyncAttempt)
            ) return false;
            if (orcidError == null) {
            ...
            if (updatedInORCID == null) {
                  ...
                  !updatedInORCID.equals(other.updatedInORCID)
            ) return false;
            if (orcidId == null) {

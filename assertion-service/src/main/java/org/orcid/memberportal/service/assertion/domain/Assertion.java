...
public class Assertion implements Serializable {
  ...
  public boolean equals(Object obj) {
    ...
    } else if (!disambiguatedOrgId.equals(other.disambiguatedOrgId)) return false;
    if (disambiguationSource == null) {
      if (other.disambiguationSource != null) return false;
    } else if (!disambiguationSource.equals(other.disambiguationSource)) return false;
    if (email == null) {
    ...
    } else if (!notificationSent.equals(other.notificationSent)) return false;
    return true;
  }
}

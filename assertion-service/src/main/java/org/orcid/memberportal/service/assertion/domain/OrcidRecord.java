...
public class OrcidRecord {
  ...
  public boolean equals(Object obj) {
    ...
    } else if (!reminderNotificationSentDate.equals(other.reminderNotificationSentDate)) return false;
    if (revokeNotificationSentDate == null) {
      if (other.revokeNotificationSentDate != null) return false;
    } else if (!revokeNotificationSentDate.equals(other.revokeNotificationSentDate)) return false;
    return true;
  }
}

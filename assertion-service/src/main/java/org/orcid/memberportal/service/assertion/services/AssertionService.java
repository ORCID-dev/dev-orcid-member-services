...
public class AssertionService {
  ...
  private String postToOrcidRegistry(String orcid, Assertion assertion, String idToken)
  ...
  private void putInOrcidRegistry(String orcid, Assertion assertion, String idToken)
  ...
  public void updateOrcidIdsForEmailAndSalesforceId(String email, String salesforceId) {
    ...
    assertions
      .stream()
      .filter(a -> a.getOrcidId() == null && salesforceId.equals(a.getSalesforceId()))
      .forEach(a -> {
        a.setOrcidId(orcid);
        assertionRepository.save(a);
      });

...
public class AssertionService {
    ...
    public Assertion createAssertion(
        ...
        if (!optionalRecord.isPresent()) {
            ...
            if (
                ...
                record
                    .getTokens()
                    .add(new OrcidToken(assertion.getSalesforceId(), null));
    ...
    public Assertion updateAssertion(
        ...
        if (
            !user.getSalesforceId().equals(existingAssertion.getSalesforceId())
        ) {
    ...
    private boolean duplicates(Assertion a, Assertion b) {
        ...
        return (
            !different(a.getAffiliationSection(), b.getAffiliationSection()) &&
    ...
    public void postAssertionToOrcid(Assertion assertion) throws JAXBException {
        ...
        if (
            tokenAndOrcidIdAvailable(record, assertion) && deniedStatus == null
        ) {
        ...
        for (MemberAssertionStatusCount count : counts) {
            if (!stats.containsKey(count.getSalesforceId())) {
                ...
                memberStats.setMemberName(
                    memberService.getMemberName(count.getSalesforceId())
                );
                stats.put(count.getSalesforceId(), memberStats);
            }
            stats
                .get(count.getSalesforceId())
                .setStatusCount(count.getStatus(), count.getStatusCount());
        }
        return stats;
    }
    ...
    private AssertionsUpload readUpload(File file, AssertionServiceUser user) {
        ...
        try {
            ...
            upload =
                assertionsCsvReader.readAssertionsUpload(inputStream, user);
        } catch (IOException e) {
    ...
    private void setPrettyStatus(Assertion assertion) {
        if (assertion.getStatus() != null) {
            assertion.setPrettyStatus(
                AssertionStatus.valueOf(assertion.getStatus()).getValue()
            );
        }
    }

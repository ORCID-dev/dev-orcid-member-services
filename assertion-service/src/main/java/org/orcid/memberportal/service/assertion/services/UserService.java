...
public class UserService {
      ...
      public AssertionServiceUser getLoggedInUser() {
            ...
            ResponseEntity<AssertionServiceUser> userResponse =
      ...
      public AssertionServiceUser getLoginAsUser(
            AssertionServiceUser loggedInUser
      ) {
            ...
            LOG.error(
                  "No user found in user service for impersonated user for admin {}",
                  loggedInUser.getEmail()
            );
            throw new IllegalArgumentException(
                  "No user found for impersonated user for admin" +
                  loggedInUser.getEmail()
            );
      }
      ...
      public List<AssertionServiceUser> getUsersBySalesforceId(
            String salesforceId
      ) {
            ResponseEntity<List<AssertionServiceUser>> response =

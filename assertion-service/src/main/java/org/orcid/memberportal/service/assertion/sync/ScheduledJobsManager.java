...
public class ScheduledJobsManager {
    ...
    @Scheduled(
        initialDelay = 90000,
        fixedDelayString = "${application.syncAffiliationsDelay}"
    )
    @SchedulerLock(
        name = "syncAffiliations",
        lockAtMostFor = "20m",
        lockAtLeastFor = "2m"
    )
    ...
    @SchedulerLock(
        name = "generateMemberAssertionStats",
        lockAtMostFor = "60m",
        lockAtLeastFor = "10m"
    )
    ...
    @Scheduled(
        initialDelay = 90000,
        fixedDelayString = "${application.processAssertionUploadsDelay}"
    )
    @SchedulerLock(
        name = "processAssertionUploads",
        lockAtMostFor = "60m",
        lockAtLeastFor = "2m"
    )
    ...
    @Scheduled(
        initialDelay = 90000,
        fixedDelayString = "${application.removeStoredFilesDelay}"
    )
    @SchedulerLock(
        name = "removeStoredFiles",
        lockAtMostFor = "60m",
        lockAtLeastFor = "2m"
    )
    ...
    @Scheduled(
        initialDelay = 90000,
        fixedDelayString = "${application.processCsvReportsDelay}"
    )
    @SchedulerLock(
        name = "processCsvReports",
        lockAtMostFor = "60m",
        lockAtLeastFor = "2m"
    )
    ...
    @Scheduled(
        initialDelay = 90000,
        fixedDelayString = "${application.sendPermissionLinkNotificationsDelay}"
    )
    @SchedulerLock(
        name = "sendPermissionLinkNotifications",
        lockAtMostFor = "60m",
        lockAtLeastFor = "2m"
    )

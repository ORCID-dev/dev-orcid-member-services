...
class CsvWriterTest {
      ...
      void testWriteCsv() throws IOException {
            ...
            assertThat(line)
                  .isEqualTo("row0-column1,row0-column2,row0-column3"); // line 1

            line = reader.readLine();
            assertThat(line)
                  .isEqualTo("row1-column1,row1-column2,row1-column3"); // line 2

            line = reader.readLine();
            assertThat(line)
                  .isEqualTo("row2-column1,row2-column2,row2-column3"); // line 3

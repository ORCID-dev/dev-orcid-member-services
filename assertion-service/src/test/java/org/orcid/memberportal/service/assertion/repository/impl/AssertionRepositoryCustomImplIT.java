...
public class AssertionRepositoryCustomImplIT {
      ...
      public void testFindAllToCreateInOrcidRegistry() {
            ...
            List<Assertion> toCreate =
                  assertionRepositoryCustom.findAllToCreateInOrcidRegistry(
                        pageable
                  );
            assertThat(toCreate.size()).isEqualTo(10);
            toCreate.forEach(a ->
                  assertThat(a.getRoleTitle()).startsWith("create")
            );
      }
      ...
      public void testFindAllToUpdateInOrcidRegistry() {
            ...
            List<Assertion> toUpdate =
                  assertionRepositoryCustom.findAllToUpdateInOrcidRegistry(
                        pageable
                  );
            assertThat(toUpdate.size()).isEqualTo(10);
            toUpdate.forEach(a -> {
                  Assertion reloaded = assertionRepository
                        .findById(a.getId())
                        .get();

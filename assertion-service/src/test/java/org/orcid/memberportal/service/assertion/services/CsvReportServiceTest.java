...
class CsvReportServiceTest {
      ...
      void testProcessCsvReports() throws IOException {
            ...
            Mockito
                  .when(
                        assertionsReportCsvWriter.writeCsv(
            ...
            Mockito
                  .when(
                        assertionsForEditCsvWriter.writeCsv(
                              Mockito.eq("salesforce")
                        )
                  )
                  .thenReturn("report");
            Mockito
                  .when(
                        permissionLinksCsvWriter.writeCsv(
                              Mockito.eq("salesforce")
                        )
                  )
                  .thenReturn("report");
      ...
      void testStoreCsvReportRequest() {
            ...
            assertThat(stored.getStatus())
                  .isEqualTo(CsvReport.UNPROCESSED_STATUS);
            assertThat(stored.getOriginalFilename())
                  .isEqualTo("some-filename.csv");

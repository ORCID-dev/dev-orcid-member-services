...
class NotificationServiceTest {
  ...
  void testSendPermissionLinkNotifications() throws IOException, JAXBException {
    ...
    Mockito
      .when(assertionRepository.findDistinctEmailsWithNotificationRequested(Mockito.eq("salesforceId1")))
      .thenReturn(Arrays.asList("email1").iterator());
    Mockito
      .when(assertionRepository.findDistinctEmailsWithNotificationRequested(Mockito.eq("salesforceId2")))
      .thenReturn(Arrays.asList("email2").iterator());
    Mockito
      .when(assertionRepository.findDistinctEmailsWithNotificationRequested(Mockito.eq("salesforceId3")))
      .thenReturn(Arrays.asList("email3").iterator());
    Mockito
      .when(assertionRepository.findDistinctEmailsWithNotificationRequested(Mockito.eq("salesforceId4")))
      .thenReturn(Arrays.asList("email4", "email5").iterator());
    Mockito
      .when(assertionRepository.findDistinctEmailsWithNotificationRequested(Mockito.eq("salesforceId5")))
    ...
    Mockito
      ...
      .thenReturn(getListOfAssertionsForNotification(1, "email1", "salesforceId1"));
    Mockito
      .when(
        assertionRepository.findByEmailAndSalesforceIdAndStatus(
          Mockito.eq("email2"),
      ...
      .thenReturn(getListOfAssertionsForNotification(3, "email2", "salesforceId2"));
    Mockito
      .when(
        assertionRepository.findByEmailAndSalesforceIdAndStatus(
          Mockito.eq("email3"),
      ...
      .thenReturn(getListOfAssertionsForNotification(5, "email3", "salesforceId3"));
    Mockito
      .when(
        assertionRepository.findByEmailAndSalesforceIdAndStatus(
          Mockito.eq("email4"),
      ...
      .thenReturn(getListOfAssertionsForNotification(7, "email4", "salesforceId4"));
    Mockito
      .when(
        assertionRepository.findByEmailAndSalesforceIdAndStatus(
          Mockito.eq("email5"),
      ...
      .thenReturn(getListOfAssertionsForNotification(2, "email5", "salesforceId4"));
    Mockito
      .when(
        assertionRepository.findByEmailAndSalesforceIdAndStatus(
          Mockito.eq("email5"),
      ...
      .thenReturn(getListOfAssertionsForNotification(9, "email5", "salesforceId5"));
    Mockito
      .when(
        assertionRepository.findByEmailAndSalesforceIdAndStatus(
          Mockito.eq("email6"),
      ...
      .thenReturn(getListOfAssertionsForNotification(4, "email6", "salesforceId5"));

    Mockito
      .when(orcidRecordService.generateLinkForEmailAndSalesforceId(Mockito.eq("email1"), Mockito.eq("salesforceId1")))
      .thenReturn("link1");
    Mockito
      .when(orcidRecordService.generateLinkForEmailAndSalesforceId(Mockito.eq("email2"), Mockito.eq("salesforceId2")))
      .thenReturn("link2");
    Mockito
      .when(orcidRecordService.generateLinkForEmailAndSalesforceId(Mockito.eq("email3"), Mockito.eq("salesforceId3")))
      .thenReturn("link3");
    Mockito
      .when(orcidRecordService.generateLinkForEmailAndSalesforceId(Mockito.eq("email4"), Mockito.eq("salesforceId4")))
      .thenReturn("link4");
    Mockito
      .when(orcidRecordService.generateLinkForEmailAndSalesforceId(Mockito.eq("email5"), Mockito.eq("salesforceId4")))
      .thenReturn("link4a");
    Mockito
      .when(orcidRecordService.generateLinkForEmailAndSalesforceId(Mockito.eq("email5"), Mockito.eq("salesforceId5")))
      .thenReturn("link5");
    Mockito
      .when(orcidRecordService.generateLinkForEmailAndSalesforceId(Mockito.eq("email6"), Mockito.eq("salesforceId5")))
      .thenReturn("link6");

    Mockito
      .when(messageSource.getMessage(Mockito.eq("assertion.notifications.introduction"), Mockito.isNull(), Mockito.any(Locale.class)))
      .thenReturn("intro");
    Mockito
      .when(messageSource.getMessage(Mockito.eq("assertion.notifications.subject"), Mockito.isNotNull(), Mockito.any(Locale.class)))
      .thenReturn("subject");
    ...
    Mockito
      ...
      .getMessage(Mockito.eq("assertion.notifications.introduction"), Mockito.isNull(), Mockito.any(Locale.class));
    Mockito
      .verify(messageSource, Mockito.times(5))
      .getMessage(Mockito.eq("assertion.notifications.subject"), Mockito.isNotNull(), Mockito.any(Locale.class));
    ...
    Mockito
      ...
      .sendNotificationsSummary(Mockito.any(AssertionServiceUser.class), Mockito.anyInt(), Mockito.anyInt());
  ...
  void testSendPermissionLinkNotifications_apiError() throws IOException, JAXBException {
    ...
    Mockito.when(orcidApiClient.getOrcidIdForEmail(Mockito.eq("email1"))).thenReturn("orcid1");
    Mockito
      .when(orcidApiClient.postNotification(Mockito.any(NotificationPermission.class), Mockito.eq("orcid1")))
  ...
  void testSendPermissionLinkNotifications_notificationForAssertion_previouslySent() throws IOException, JAXBException {
    ...
    Mockito
      ...
      .thenReturn(Arrays.asList(assertionForWhichNotificationPreviouslySent));
    Mockito
      .when(orcidRecordService.generateLinkForEmailAndSalesforceId(Mockito.eq("email1"), Mockito.eq("salesforceId1")))
      .thenReturn("link1");
    Mockito
  ...
  void testSendPermissionLinkNotifications_invitationForAssertion_previouslySent() throws IOException, JAXBException {
    ...
    Mockito
      ...
      .thenReturn(Arrays.asList(assertionForWhichInvitationPreviouslySent));
    Mockito
      .when(orcidRecordService.generateLinkForEmailAndSalesforceId(Mockito.eq("email1"), Mockito.eq("salesforceId1")))
      .thenReturn("link1");
  ...
  void testCreateSendNotificationsRequest() {
    Mockito
      .when(sendNotificationsRequestRepository.findActiveRequestBySalesforceId(Mockito.eq("somethingElse")))
  ...
  void testCreateSendNotificationsRequest_requestInProgress() {
    Mockito
      .when(sendNotificationsRequestRepository.findActiveRequestBySalesforceId(Mockito.eq("salesforceId")))
  ...
  void testResendNotifications_notificationsAlreadyResent() throws IOException, JAXBException {
    ...
    Mockito
      .when(assertionRepository.findNotificationResendCandidates(Mockito.any(Pageable.class)))
    ...
    Mockito
      ...
      .sendInvitationEmail(Mockito.anyString(), Mockito.anyString(), Mockito.anyString(), Mockito.anyString());
  ...
  void testResendNotifications_firstNotificationResendDue() throws IOException, JAXBException {
    ...
    Mockito
      ...
      .getMessage(Mockito.eq("assertion.notifications.introduction"), Mockito.isNull(), Mockito.eq(Locale.TRADITIONAL_CHINESE));
    Mockito
      .verify(messageSource, Mockito.times(10))
      .getMessage(Mockito.eq("assertion.notifications.subject"), Mockito.any(), Mockito.eq(Locale.TRADITIONAL_CHINESE));
  }

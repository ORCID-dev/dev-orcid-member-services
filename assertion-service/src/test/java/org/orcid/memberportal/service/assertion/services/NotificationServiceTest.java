...
class NotificationServiceTest {
      ...
      void testSendPermissionLinkNotifications()
            ...
            Mockito
                  .when(
                        memberService.getMemberName(Mockito.eq("salesforceId3"))
                  )
                  .thenReturn("Member 3");
            Mockito
                  .when(
                        memberService.getMemberName(Mockito.eq("salesforceId4"))
                  )
                  .thenReturn("Member 4");
            Mockito
                  .when(
                        memberService.getMemberName(Mockito.eq("salesforceId5"))
                  )
                  .thenReturn("Member 5");
            ...
            Mockito
                  ...
                  .thenReturn(
                        getListOfAssertionsForNotification(
                              1,
                              "email1",
                              "salesforceId1"
                        )
            ...
            Mockito
                  ...
                  .getOrcidIdForEmail(Mockito.eq("email1"));
            Mockito
                  .verify(orcidApiClient)
                  .getOrcidIdForEmail(Mockito.eq("email2"));
            Mockito
                  .verify(orcidApiClient)
                  .getOrcidIdForEmail(Mockito.eq("email3"));
            Mockito
                  .verify(orcidApiClient)
                  .getOrcidIdForEmail(Mockito.eq("email4"));
            Mockito
      ...
      void testSendPermissionLinkNotifications_notificationForAssertion_previouslySent()
            throws IOException, JAXBException {
            Assertion assertionForWhichNotificationPreviouslySent =
                  getAssertion();
            ...
            Mockito
                  ...
                  .thenReturn(
                        Arrays.asList(
                              assertionForWhichNotificationPreviouslySent
                        )
                  );
            Mockito
                  .when(
            ...
            Mockito.verify(assertionRepository).save(assertionCaptor.capture());
            Assertion a = assertionCaptor.getValue();
            assertThat(a.getNotificationSent())
                  .isEqualTo(notificationFirstSent);
            assertThat(a.getNotificationLastSent()).isNotNull();
      ...
      void testSendPermissionLinkNotifications_invitationForAssertion_previouslySent()
            throws IOException, JAXBException {
            Assertion assertionForWhichInvitationPreviouslySent =
                  getAssertion();
      ...
      void testResendNotifications_secondNotificationResendDue()
            ...
            pageOfAssertions.forEach(a -> {
                  ...
                  a.setNotificationSent(
                        Instant.now().minus(31, ChronoUnit.DAYS)
                  );
                  a.setNotificationLastSent(
      ...
      private void checkNotificationPermissionObject(
            ...
            for (int i = 0; i < expectedNumberOfItems; i++) {
                  Item item = notificationPermission
                        .getItems()
                        .getItems()
                        .get(i);

...
class NotificationServiceTest {
    ...
    @Test
    void testSendPermissionLinkNotifications()
        throws IOException, JAXBException {
        Mockito
            .when(sendNotificationsRequestRepository.findActiveRequests())
            .thenReturn(getListOfManyRequests());

        Mockito
            .when(
                assertionRepository.findDistinctEmailsWithNotificationRequested(
                    Mockito.eq("salesforceId1")
                )
            )
            .thenReturn(Arrays.asList("email1").iterator());
        Mockito
            .when(
                assertionRepository.findDistinctEmailsWithNotificationRequested(
                    Mockito.eq("salesforceId2")
                )
            )
            .thenReturn(Arrays.asList("email2").iterator());
        Mockito
            .when(
                assertionRepository.findDistinctEmailsWithNotificationRequested(
                    Mockito.eq("salesforceId3")
                )
            )
            .thenReturn(Arrays.asList("email3").iterator());
        Mockito
            .when(
                assertionRepository.findDistinctEmailsWithNotificationRequested(
                    Mockito.eq("salesforceId4")
                )
            )
            .thenReturn(Arrays.asList("email4", "email5").iterator());
        Mockito
            .when(
                assertionRepository.findDistinctEmailsWithNotificationRequested(
                    Mockito.eq("salesforceId5")
                )
            )
            .thenReturn(Arrays.asList("email5", "email6").iterator());
        ...
        Mockito
            ...
            .thenReturn("Member 2");
        Mockito
            .when(memberService.getMemberName(Mockito.eq("salesforceId3")))
            .thenReturn("Member 3");
        Mockito
            .when(memberService.getMemberName(Mockito.eq("salesforceId4")))
            .thenReturn("Member 4");
        Mockito
            .when(memberService.getMemberName(Mockito.eq("salesforceId5")))
            .thenReturn("Member 5");
        ...
        Mockito
            .when(
                assertionRepository.findByEmailAndSalesforceIdAndStatus(
                    Mockito.eq("email1"),
                    Mockito.eq("salesforceId1"),
                    Mockito.eq(AssertionStatus.NOTIFICATION_REQUESTED.name())
                )
            )
            .thenReturn(
                getListOfAssertionsForNotification(1, "email1", "salesforceId1")
            );
        Mockito
            .when(
                assertionRepository.findByEmailAndSalesforceIdAndStatus(
            ...
            .thenReturn(
                getListOfAssertionsForNotification(3, "email2", "salesforceId2")
            );
        Mockito
            .when(
                assertionRepository.findByEmailAndSalesforceIdAndStatus(
            ...
            .thenReturn(
                getListOfAssertionsForNotification(5, "email3", "salesforceId3")
            );
        Mockito
            .when(
                assertionRepository.findByEmailAndSalesforceIdAndStatus(
            ...
            .thenReturn(
                getListOfAssertionsForNotification(7, "email4", "salesforceId4")
            );
        Mockito
            .when(
                assertionRepository.findByEmailAndSalesforceIdAndStatus(
            ...
            .thenReturn(
                getListOfAssertionsForNotification(2, "email5", "salesforceId4")
            );
        Mockito
            .when(
                assertionRepository.findByEmailAndSalesforceIdAndStatus(
            ...
            .thenReturn(
                getListOfAssertionsForNotification(9, "email5", "salesforceId5")
            );
        Mockito
            .when(
                assertionRepository.findByEmailAndSalesforceIdAndStatus(
            ...
            .thenReturn(
                getListOfAssertionsForNotification(4, "email6", "salesforceId5")
            );
        ...
        Mockito
            .when(
                messageSource.getMessage(
                    Mockito.eq("assertion.notifications.introduction"),
                    Mockito.isNull(),
        ...
        Mockito
            .when(
                messageSource.getMessage(
                    Mockito.eq("assertion.notifications.subject"),
                    Mockito.isNotNull(),
                    Mockito.any(Locale.class)
                )
            )
        ...
        Mockito
            .when(orcidApiClient.getOrcidIdForEmail(Mockito.eq("email1")))
            .thenReturn("orcid1");
        Mockito
            .when(orcidApiClient.getOrcidIdForEmail(Mockito.eq("email2")))
            .thenReturn("orcid2");
        Mockito
            .when(orcidApiClient.getOrcidIdForEmail(Mockito.eq("email3")))
            .thenReturn("orcid3");
        Mockito
            .when(orcidApiClient.getOrcidIdForEmail(Mockito.eq("email4")))
            .thenReturn("orcid4");
        Mockito
            .when(orcidApiClient.getOrcidIdForEmail(Mockito.eq("email5")))
            .thenReturn(null);
        Mockito
            .when(orcidApiClient.getOrcidIdForEmail(Mockito.eq("email6")))
            .thenReturn("orcid6");

        Mockito
            .when(memberService.getMemberDefaultLanguage(Mockito.anyString()))
            .thenReturn("en");
        ...
        Mockito
            ...
            .findByEmailAndSalesforceIdAndStatus(
                Mockito.eq("email1"),
                Mockito.eq("salesforceId1"),
                Mockito.eq(AssertionStatus.NOTIFICATION_REQUESTED.name())
            );
        ...
        Mockito
            ...
            .getMemberName(Mockito.eq("salesforceId1"));
        Mockito
            .verify(memberService)
            .getMemberName(Mockito.eq("salesforceId2"));
        Mockito
            .verify(memberService)
            .getMemberName(Mockito.eq("salesforceId3"));
        Mockito
            .verify(memberService)
            .getMemberName(Mockito.eq("salesforceId4"));
        Mockito
            .verify(memberService)
            .getMemberName(Mockito.eq("salesforceId5"));
        ...
        Mockito
            .verify(orcidApiClient, Mockito.times(2))
            .getOrcidIdForEmail(Mockito.eq("email5"));

        Mockito
            .verify(messageSource, Mockito.times(5))
            .getMessage(
                Mockito.eq("assertion.notifications.introduction"),
                Mockito.isNull(),
                Mockito.any(Locale.class)
        ...
        Mockito
            ...
            .generateLinkForEmailAndSalesforceId(
                Mockito.eq("email1"),
                Mockito.eq("salesforceId1")
            );
        Mockito
        ...
        Mockito
            .verify(assertionRepository, Mockito.times(31))
            .save(assertionCaptor.capture()); // 31 total assertions updated (1 + 3 + 5 + 7 + 2 + 9 + 4)
        ...
        assertionsUpdated.forEach(a -> {
            if (a.getEmail().equals("email5")) {
                ...
                assertThat(a.getStatus())
                    .isEqualTo(AssertionStatus.NOTIFICATION_SENT.name());
        ...
        Mockito
            .verify(orcidApiClient)
            .postNotification(
                notificationPermissionCaptor.capture(),
                Mockito.eq("orcid1")
            );
        NotificationPermission notificationPermission =
            notificationPermissionCaptor.getValue();
        ...
        Mockito
            .verify(sendNotificationsRequestRepository, Mockito.times(5))
            .save(requestCaptor.capture());
        List<SendNotificationsRequest> savedRequests =
        ...
        Mockito
            .verify(mailService, Mockito.times(5))
    ...
    @Test
    void testSendPermissionLinkNotifications_emptyRoleTitle()
        throws IOException, JAXBException {
        Mockito
            .when(sendNotificationsRequestRepository.findActiveRequests())
            .thenReturn(getListOfOneRequest("salesforceId1"));
        Mockito
            .when(
                assertionRepository.findDistinctEmailsWithNotificationRequested(
                    Mockito.eq("salesforceId1")
        ...
        Mockito
            ...
            .thenReturn(Arrays.asList(getAssertionWithNoRoleTitle()));
        Mockito
            .when(
                orcidRecordService.generateLinkForEmailAndSalesforceId(
                    Mockito.eq("email1"),
        ...
        Mockito
            .when(
                memberService.getMemberDefaultLanguage(
                    Mockito.eq("salesforceId1")
                )
            )
            .thenReturn("en");
        ...
        assertThat(
            ...
            .isEqualTo("org name"); // check no role title in name
    }

    @Test
    void testSendPermissionLinkNotifications_apiError()
        throws IOException, JAXBException {
        Mockito
            .when(sendNotificationsRequestRepository.findActiveRequests())
            .thenReturn(getListOfOneRequest("salesforceId1"));
        ...
        Mockito
            .when(
                orcidApiClient.postNotification(
                    Mockito.any(NotificationPermission.class),
                    Mockito.eq("orcid1")
                )
            )
            .thenThrow(new ORCIDAPIException(400, "bad request"));
        ...
        assertThat(a.getStatus())
            .isEqualTo(AssertionStatus.NOTIFICATION_FAILED.name());
    ...
    @Test
    void testSendPermissionLinkNotifications_notificationForAssertion_previouslySent()
        throws IOException, JAXBException {
        Assertion assertionForWhichNotificationPreviouslySent = getAssertion();
        Instant notificationFirstSent = Instant.now();
        assertionForWhichNotificationPreviouslySent.setNotificationSent(
            notificationFirstSent
        );
        ...
        Mockito
            ...
            .thenReturn(
                Arrays.asList(assertionForWhichNotificationPreviouslySent)
            );
        Mockito
            .when(
                orcidRecordService.generateLinkForEmailAndSalesforceId(
    ...
    @Test
    void testSendPermissionLinkNotifications_notificationForAssertion_notPreviouslySent()
        throws IOException, JAXBException {
        Assertion assertionForWhichNotificationPreviouslySent = getAssertion();
    ...
    @Test
    void testSendPermissionLinkNotifications_invitationForAssertion_previouslySent()
        throws IOException, JAXBException {
        Assertion assertionForWhichInvitationPreviouslySent = getAssertion();
        Instant invitationFirstSent = Instant.now();
        assertionForWhichInvitationPreviouslySent.setInvitationSent(
            invitationFirstSent
        );
        ...
        Mockito
            ...
            .thenReturn(
                Arrays.asList(assertionForWhichInvitationPreviouslySent)
            );
        Mockito
            .when(
                orcidRecordService.generateLinkForEmailAndSalesforceId(
    ...
    @Test
    void testSendPermissionLinkNotifications_invitationForAssertion_notPreviouslySent()
        throws IOException, JAXBException {
        Assertion assertionForWhichInvitationPreviouslySent = getAssertion();
        ...
        Mockito
            .when(
                sendNotificationsRequestRepository.findActiveRequestBySalesforceId(
                    Mockito.eq("somethingElse")
                )
            )
            .thenReturn(new ArrayList<>());
        Mockito
            .when(
                sendNotificationsRequestRepository.insert(
                    Mockito.any(SendNotificationsRequest.class)
                )
            )
            .thenReturn(null);
        notificationService.createSendNotificationsRequest(
            "email",
            "salesforceId"
        );
        Mockito
            .verify(sendNotificationsRequestRepository)
            .insert(requestCaptor.capture());
    ...
    void testCreateSendNotificationsRequest_requestInProgress() {
        Mockito
            ...
            .thenReturn(getListOfOneRequest("salesforceId"));
    ...
    void testRequestInProgress() {
        ...
        boolean inProgress = notificationService.requestInProgress(
            "salesforceId"
        );
    ...
    @Test
    void testResendNotifications_notificationsAlreadyResent()
        throws IOException, JAXBException {
        ...
        Mockito
            .when(
                assertionRepository.findNotificationResendCandidates(
                    Mockito.any(Pageable.class)
                )
            )
            .thenReturn(pageOfAssertions)
            .thenReturn(null);
        Mockito
            .when(
            ...
            .thenReturn(false);
        Mockito
            .when(applicationProperies.getResendNotificationDays())
            .thenReturn(new int[] { 7, 30 });

        notificationService.resendNotifications();

        // check nothing happens other than checks
        Mockito
            .verify(orcidRecordService, Mockito.times(10))
            .userHasGrantedOrDeniedPermission(
                Mockito.anyString(),
                Mockito.anyString()
            );
        Mockito
            .verify(orcidApiClient, Mockito.never())
            .getOrcidIdForEmail(Mockito.anyString());
        Mockito
    ...
    @Test
    void testResendNotifications_invitationsAlreadyResent()
        throws IOException, JAXBException {
    ...
    @Test
    void testResendNotifications_firstNotificationResendDue()
        throws IOException, JAXBException {
        // build page of assertions, all have just had invitation sent so nothing should be sent now
        Page<Assertion> pageOfAssertions = getPageOfAssertions();
        pageOfAssertions.forEach(a -> {
        ...
        Mockito
            ...
            .thenReturn(false);
        Mockito
            .when(orcidApiClient.getOrcidIdForEmail(Mockito.anyString()))
            .thenReturn("orcid");
        Mockito
            .when(applicationProperies.getResendNotificationDays())
            .thenReturn(new int[] { 7, 30 });
        Mockito
            .when(memberService.getMemberName(Mockito.eq("salesforceId")))
            .thenReturn("Member 1");
        Mockito
            .when(
                memberService.getMemberDefaultLanguage(
        ...
        Mockito
            .verify(orcidApiClient, Mockito.times(10))
            .getOrcidIdForEmail(Mockito.anyString());
        Mockito
            .verify(mailService, Mockito.never())
            .sendInvitationEmail(
        ...
        Mockito
            .verify(messageSource, Mockito.times(10))
            .getMessage(
                Mockito.eq("assertion.notifications.introduction"),
                Mockito.isNull(),
                Mockito.eq(Locale.TRADITIONAL_CHINESE)
            );
        Mockito
            .verify(messageSource, Mockito.times(10))
            .getMessage(
    ...
    @Test
    void testResendNotifications_secondNotificationResendDue()
        throws IOException, JAXBException {
        // build page of assertions, all have just had invitation sent so nothing should be sent now
        Page<Assertion> pageOfAssertions = getPageOfAssertions();
        pageOfAssertions.forEach(a -> {
    ...
    @Test
    void testResendNotifications_firstInvitationResendDue()
        throws IOException, JAXBException {
        Page<Assertion> pageOfAssertions = getPageOfAssertions();
        pageOfAssertions.forEach(a -> {
            Instant sent = Instant.now().minus(8, ChronoUnit.DAYS);
        ...
        Mockito
            ...
            .thenReturn(new int[] { 7, 30 });
        Mockito
            .when(memberService.getMemberName(Mockito.anyString()))
            .thenReturn("member name");
        Mockito
            .when(memberService.getMemberDefaultLanguage(Mockito.anyString()))
            .thenReturn("en");
        Mockito
        ...
        Mockito
            ...
            .getOrcidIdForEmail(Mockito.anyString());
        Mockito
            .verify(mailService, Mockito.times(10))
            .sendInvitationEmail(
                Mockito.anyString(),
                Mockito.anyString(),
                Mockito.anyString(),
    ...
    @Test
    void testResendNotifications_secondInvitationResendDue()
        throws IOException, JAXBException {
        Page<Assertion> pageOfAssertions = getPageOfAssertions();
        pageOfAssertions.forEach(a -> {
            // first sent a month ago, first resent a week later, second resend now due
    ...
    @Test
    void testResendNotifications_usersHaveRespondedToInvitation()
        throws IOException, JAXBException {
        Page<Assertion> pageOfAssertions = getPageOfAssertions();
    ...
    private List<SendNotificationsRequest> getListOfManyRequests() {
        return Arrays.asList(
            getRequest("salesforceId1"),
            getRequest("salesforceId2"),
            getRequest("salesforceId3"),
            getRequest("salesforceId4"),
            getRequest("salesforceId5")
        );
    }
    ...
    private void checkNotificationPermissionObject(
        NotificationPermission notificationPermission,
        String variant,
        ...
        assertThat(notificationPermission.getAuthorizationUrl().getUri())
            .isEqualTo("link" + variant);
        assertThat(notificationPermission.getItems().getItems().size())
        ...
        for (int i = 0; i < expectedNumberOfItems; i++) {
            ...
            assertThat(item.getItemName())
                .isEqualTo("org name " + i + " : " + "role " + i);
            assertThat(item.getItemType()).isEqualTo(ItemType.EDUCATION);
        }
    }

    private List<Assertion> getListOfAssertionsForNotification(
        int size,
        String email,
        String salesforceId
    ) {

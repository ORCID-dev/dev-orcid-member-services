...
public class AuthorizationHeaderUtil {
      ...
      public Optional<String> getAuthorizationHeader() {
            ...
            if (accessToken != null) {
                  ...
                  if (isExpired(accessToken)) {
                        log.info(
                              "AccessToken expired, refreshing automatically"
                        );
      ...
      private String refreshToken(
            ...
            OAuth2RefreshToken refreshToken = atr.getRefreshToken() != null
                  ? atr.getRefreshToken()
      ...
      private OAuth2AccessTokenResponse refreshTokenClient(
            OAuth2AuthorizedClient currentClient
      ) {
            ...
            try {
                  ...
                  ResponseEntity<OAuthIdpTokenResponseDTO> responseEntity =
                        r.exchange(
                              requestEntity,
                              OAuthIdpTokenResponseDTO.class
                        );
      ...
      private OAuth2AccessTokenResponse toOAuth2AccessTokenResponse(
            ...
            additionalParameters.put(
                  "not-before-policy",
                  oAuthIdpResponse.getNotBefore()
            );
            additionalParameters.put(
                  "refresh_expires_in",
                  oAuthIdpResponse.getRefreshExpiresIn()
            );
            additionalParameters.put(
                  "session_state",
                  oAuthIdpResponse.getSessionState()
            );

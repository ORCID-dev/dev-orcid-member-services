...
public class UaaAuthorizationHeaderUtil {
      ...
      private Optional<OAuth2AuthorizedClient> refreshAuthorizedClient(
            ...
            OAuth2AccessToken accessToken = retrieveNewAccessToken(
                  clientRegistration
            );
            if (accessToken == null) {
            ...
            clientRegistrationService.saveAuthorizedClient(

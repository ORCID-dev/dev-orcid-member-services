...
public class UaaAuthorizationHeaderUtil {
  ...
  public String getAuthorizationHeader() {
    ...
    return client
      ...
      .orElseThrow(() ->
        new OAuth2AuthorizationException(new OAuth2Error(OAuth2ErrorCodes.UNAUTHORIZED_CLIENT, "Unable to get access token for user", null))
      );
  }
  ...
  private Optional<OAuth2AuthorizedClient> refreshAuthorizedClient(Authentication authentication) {
    ...
    OAuth2AuthorizedClient updatedAuthorizedClient = new OAuth2AuthorizedClient(clientRegistration, authentication.getName(), accessToken);

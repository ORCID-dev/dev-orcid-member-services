...
public class RoutesResource {
        ...
        routes
            ...
            .map(route -> {
                ...
                routeVM.setServiceInstances(
                    discoveryClient.getInstances(route.getId())
                );
            ...
            .filter(routeVM ->
                routeVM.getServiceInstances() == null ||
                routeVM.getServiceInstances().isEmpty()
            )
            ...
            zuulProperties
                ...
                .forEach(oneRoute -> {
                    if (oneRoute instanceof ZuulRouteDTO) {
                        routeVMs
                            .get(oneRoute.getId())
                            .setStatus(((ZuulRouteDTO) oneRoute).getStatus());
                    }
                });
        }
    }
    ...
    private RouteVM registryRoute() {
        return new RouteVM(
            ...
            null,
            registryName,
            InstanceInfo.InstanceStatus.UP.toString(),
            null
        );
    }

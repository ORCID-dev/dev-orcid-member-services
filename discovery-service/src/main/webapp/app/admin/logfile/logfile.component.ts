...
export class LogfileComponent implements OnInit, OnDestroy {
  ...
  constructor(
    private jhiLogfileService: LogfileService,
  ...
  scrollToBottom(): void {
    this.logFileViewer!.nativeElement.scrollTop =
      this.logFileViewer!.nativeElement.scrollHeight
  }

  scrollToTop(): void {
    this.logFileViewer!.nativeElement.scrollTop =
      this.logFileViewer!.nativeElement.scrolledUp
  }

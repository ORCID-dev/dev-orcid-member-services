...
public class SwaggerBasePathRewritingFilterTest {
      ...
      private SwaggerBasePathRewritingFilter filter =
            new SwaggerBasePathRewritingFilter();
      ...
      public void run_on_valid_response() throws Exception {
            ...
            assertThat(context.getResponseBody())
                  .isEqualTo("{\"basePath\":\"/service1\"}");
      }
      ...
      public void run_on_valid_response_gzip() throws Exception {
            ...
            context.setResponseDataStream(
                  new ByteArrayInputStream(gzipData("{\"basePath\":\"/\"}"))
            );
            ...
            InputStream responseDataStream = new GZIPInputStream(

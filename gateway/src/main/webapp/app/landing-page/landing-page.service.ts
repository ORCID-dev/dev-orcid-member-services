...
export class LandingPageService {
  ...
  recordConnectionUri: string =
    SERVER_API_URL + 'services/assertionservice/api/assertion/record/'
  memberInfoUri: string =
    SERVER_API_URL + 'services/memberservice/api/members/authorized/'
  ...
  submitUserResponse(data): Observable<any> {
    return this.http.post(this.idTokenUri, JSON.stringify(data), {

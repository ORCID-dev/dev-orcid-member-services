...
public class OAuth2AuthenticationServiceTest {
      ...
      public void init() {
            ...
            jHipsterProperties
                  ...
                  .setAccessTokenUri("http://uaa/oauth/token");
            ...
            authorizationClient =
                  new UaaTokenEndpointClient(
                        restTemplate,
                        jHipsterProperties,
                        oAuth2Properties
                  );
            authenticationService =
                  new OAuth2AuthenticationService(
                        authorizationClient,
                        cookieHelper,
                        tokenStore
                  );
            when(tokenStore.readAccessToken(ACCESS_TOKEN_VALUE))
                  .thenReturn(accessToken);
            when(tokenStore.readAuthentication(Mockito.eq(accessToken)))
                  .thenReturn(
                        getMockOAuth2Authentication(
                              "username",
            ...
            refreshTokenFilter =
                  new RefreshTokenFilter(authenticationService, tokenStore);
      }

      public static OAuth2AccessToken createAccessToken(
      ...
      public static MockHttpServletRequest createMockHttpServletRequest() {
            ...
            Cookie accessTokenCookie = new Cookie(
                  OAuth2CookieHelper.ACCESS_TOKEN_COOKIE,
                  ACCESS_TOKEN_VALUE
            );
            Cookie refreshTokenCookie = new Cookie(
                  OAuth2CookieHelper.REFRESH_TOKEN_COOKIE,
                  REFRESH_TOKEN_VALUE
            );
      ...
      private OAuth2Authentication getMockOAuth2Authentication(
            String username,
            Set<String> scopes,
            Set<String> roles
      ) {
      ...
      private void mockPasswordGrant(OAuth2AccessToken accessToken) {
            ...
            when(
                  ...
                  .thenReturn(
                        new ResponseEntity<OAuth2AccessToken>(
                              accessToken,
                              HttpStatus.OK
                        )
                  );
      ...
      public void testAuthenticationCookies() {
            ...
            Cookie accessTokenCookie = response.getCookie(
                  OAuth2CookieHelper.ACCESS_TOKEN_COOKIE
            );
            ...
            Cookie refreshTokenCookie = response.getCookie(
                  OAuth2CookieHelper.REFRESH_TOKEN_COOKIE
            );
            Assertions.assertEquals(
                  REFRESH_TOKEN_VALUE,
                  OAuth2CookieHelper.getRefreshTokenValue(refreshTokenCookie)
            );
            Assertions.assertTrue(
                  OAuth2CookieHelper.isRememberMe(refreshTokenCookie)
            );
      }
      ...
      public void testAuthenticationNoRememberMe() {
            ...
            Cookie refreshTokenCookie = response.getCookie(
                  OAuth2CookieHelper.SESSION_TOKEN_COOKIE
            );
            Assertions.assertEquals(
                  REFRESH_TOKEN_VALUE,
                  OAuth2CookieHelper.getRefreshTokenValue(refreshTokenCookie)
      ...
      public void testRefreshGrant() {
            ...
            Cookie newAccessTokenCookie = response.getCookie(
                  OAuth2CookieHelper.ACCESS_TOKEN_COOKIE
            );
            Assertions.assertEquals(
                  NEW_ACCESS_TOKEN_VALUE,
            ...
            Cookie newRefreshTokenCookie = response.getCookie(
                  OAuth2CookieHelper.REFRESH_TOKEN_COOKIE
            );
            Assertions.assertEquals(
                  NEW_REFRESH_TOKEN_VALUE,
            ...
            Cookie requestAccessTokenCookie =
                  OAuth2CookieHelper.getAccessTokenCookie(newRequest);
            Assertions.assertEquals(
                  NEW_ACCESS_TOKEN_VALUE,
                  requestAccessTokenCookie.getValue()
            );
      }
      ...
      public void testSessionExpired() {
            ...
            Cookie requestRefreshTokenCookie =
                  OAuth2CookieHelper.getRefreshTokenCookie(newRequest);
      ...
      public void testRefreshGrantNoRefreshToken() {
            ...
            Assertions.assertThrows(
                  ...
                  () ->
                        refreshTokenFilter.refreshTokensIfExpiring(
                              request,
                              response
                        )
            );
      ...
      public void testStripTokens() {
            MockHttpServletRequest request = createMockHttpServletRequest();
            HttpServletRequest newRequest = authenticationService.stripTokens(
                  request
            );
            CookieCollection cookies = new CookieCollection(
                  newRequest.getCookies()
            );
            Assertions.assertFalse(
                  cookies.contains(OAuth2CookieHelper.ACCESS_TOKEN_COOKIE)
            );
            Assertions.assertFalse(
                  cookies.contains(OAuth2CookieHelper.REFRESH_TOKEN_COOKIE)
            );
      }
}

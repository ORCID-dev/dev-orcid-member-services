...
public class HealthServiceTest {
  ...
  void testCheckGlobalHealth_notAllHealthy() throws IOException {
    ...
    Mockito
      .when(healthClient.getHealth(Mockito.eq("http://localhost:8080/services/assertionservice/management/health")))
      .thenReturn(healthy());
    Mockito
      .when(healthClient.getHealth(Mockito.eq("http://localhost:8080/services/memberservice/management/health")))
  ...
  void testCheckGlobalHealth_WithError() throws IOException {
    ...
    Mockito
      ...
      .thenReturn(healthy());
    Mockito
      .when(healthClient.getHealth(Mockito.eq("http://localhost:8080/management/health")))

  ...
  describe('LoginComponent', () => {
    ...
    beforeEach(() => {
      ...
      mockStateStorageService =
        fixture.debugElement.injector.get(StateStorageService)
    ...
    it('should authenticate the user upon login when previous state was set', inject(
      ...
      fakeAsync(() => {
        ...
        expect(mockRouter.navigateByUrlSpy).toHaveBeenCalledWith(
          'admin/users?page=0'
        )
      })
    ))
    ...
    it('should empty the credentials upon cancel', () => {
      ...
      expect(comp.loginForm.get('rememberMe').value).toEqual(
        expected.rememberMe
      )

...
public interface UserServiceClient {
      ...
      ResponseEntity<MemberServiceUser> getUser(
            @PathVariable("loginOrId") String loginOrId
      );

      @RequestMapping(
            method = RequestMethod.GET,
            value = "/api/users/salesforce/{salesforceId}",
            consumes = MediaType.APPLICATION_JSON,
            produces = MediaType.APPLICATION_JSON
      )
      @HystrixProperty(
      ...
      ResponseEntity<List<MemberServiceUser>> getUsersBySalesforceId(
      ...
      @RequestMapping(
            method = RequestMethod.PUT,
            value = "/api/users/{salesforceId}/{newSalesforceId}",
            consumes = MediaType.APPLICATION_JSON,
            produces = MediaType.APPLICATION_JSON
      )
      @HystrixProperty(
      ...
      ResponseEntity<String> updateUsersSalesforceId(
            @PathVariable("salesforceId") String salesforceId,
            @PathVariable("newSalesforceId") String newSalesforceId
      );

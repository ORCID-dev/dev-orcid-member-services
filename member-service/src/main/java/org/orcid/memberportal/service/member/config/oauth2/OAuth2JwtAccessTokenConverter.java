...
public class OAuth2JwtAccessTokenConverter extends JwtAccessTokenConverter {
      ...
      private final Logger log = LoggerFactory.getLogger(
            OAuth2JwtAccessTokenConverter.class
      );
      ...
      private boolean tryCreateSignatureVerifier() {
            ...
            if (
                  ...
                  oAuth2Properties
                        .getSignatureVerification()
                        .getPublicKeyRefreshRateLimit()
            ) {
                  return false;
            }
            try {
                  SignatureVerifier verifier =
                        signatureVerifierClient.getSignatureVerifier();
                  if (verifier != null) {
                  ...
                  log.error(
                        "could not get public key from OAuth2 server to create SignatureVerifier",
                        ex
                  );
            }
            return false;

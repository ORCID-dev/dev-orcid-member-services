...
public class MailService {
  ...
  public void sendRemoveConsortiumMemberEmail(RemoveConsortiumMember removeConsortiumMember) {
    ...
    context.setVariable(
      "requestedBy",
      removeConsortiumMember.getRequestedByName() + " (" + removeConsortiumMember.getRequestedByEmail() + ")"
    );
    ...
    context.setVariable(
      "terminationDate",
      getTerminationDate(removeConsortiumMember.getTerminationMonth(), removeConsortiumMember.getTerminationYear())
    );

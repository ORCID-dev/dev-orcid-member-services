...
public class MemberService {
      ...
      public Boolean memberExists(String salesforceId) {
            Optional<Member> existingMember =
                  memberRepository.findBySalesforceId(salesforceId);
      ...
      public Member updateMember(Member member) {
            ...
            Optional<Member> optional = memberRepository.findById(
                  member.getId()
            );
            if (!optional.isPresent()) {
                  throw new BadRequestAlertException(
            ...
            existingMember.setParentSalesforceId(
                  member.getParentSalesforceId()
            );
            ...
            if (
                  !existingMember.getClientName().equals(member.getClientName())
            ) {
            ...
            if (
                  ...
                  try {
                        ...
                        LOG.info(
                              "Affiliation salesforce id rollback successfull"
                        );
                        throw new RuntimeException(e);
                  }
      ...
      public MemberValidation validateMember(Member member) {
            return memberValidator.validate(
                  member,
                  userService.getLoggedInUser()
            );
      }
      ...
      public void deleteMember(String id) {
            ...
            if (
                  usersBelongingToMember != null &&
                  !usersBelongingToMember.isEmpty()
            ) {
            ...
            if (
                  ...
                  for (MemberServiceUser user : usersBelongingToMember) {
                        ...
                        if (member.getIsConsortiumLead()) {
                              ...
                              authorities.add(
                                    AuthoritiesConstants.CONSORTIUM_LEAD
                              );
                        } else {
      ...
      public MemberDetails getCurrentMemberDetails() {
            ...
            String salesforceId = userService
                  .getLoggedInUser()
                  .getSalesforceId();
            ...
            try {
                  if (Boolean.TRUE.equals(member.getIsConsortiumLead())) {
                        ...
                        return salesforceClient.getConsortiumLeadDetails(
                              salesforceId
                        );
                  } else {
                        LOG.info(
                              "getting member details for sfid {}",
                              salesforceId
                        );
      ...
      public void processMemberContact(
      ...
      public void requestNewConsortiumMember(
            ...
            Optional<Member> optionalMember =
                  memberRepository.findBySalesforceId(user.getSalesforceId());

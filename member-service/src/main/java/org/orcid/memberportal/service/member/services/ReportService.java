...
public class ReportService {
      ...
      public ReportInfo getConsortiaReportInfo() {
            ...
            ReportInfo info = new ReportInfo();
            info.setUrl(
                  applicationProperties.getHolisticsConsortiaDashboardUrl()
            );
            info.setJwt(
                  getJwt(
                        claims,
      ...
      private Map<String, String> getConsortiaMemberAffiliationsReportPathObject() {
            ...
            path.put(
                  DATASET_PARAM,
                  CONSORTIUM_MEMBER_AFFILIATION_REPORT_DATASET
            );
      ...
      private Map<String, Object> getRowBasedConfigBase() {
            ...
            config.put(
                  VALUES_PARAM,
                  new String[] { getLoggedInSalesforceId() }
            );
            return config;
      }
}

...
public class MemberResourceTest {
      ...
      public void testGetMemberOrgIds() {
            ...
            ResponseEntity<MemberOrgIds> entity =
                  memberResource.getMemberOrgIds();
            assertEquals(200, entity.getStatusCodeValue());
      ...
      public void testUpdateMemberDefaultLanguage() {
            ResponseEntity<Void> response =
                  memberResource.updateMemberDefaultLanguage(
                        "salesforceId",
                        "en"
                  );
      ...
      public void testProcessMemberContactUpdate() {
            ...
            memberResource.processMemberContactUpdate(
                  new MemberContactUpdate()
            );
            Mockito
                  .verify(memberService)
                  .processMemberContact(Mockito.any(MemberContactUpdate.class));
      ...
      public void testRequestNewConsortiumMember() {
            Mockito
                  .doNothing()
                  .when(memberService)
                  .requestNewConsortiumMember(
                        Mockito.any(AddConsortiumMember.class)
                  );
            memberResource.requestNewConsortiumMember(
                  new AddConsortiumMember()
            );
            Mockito
                  .verify(memberService)
                  .requestNewConsortiumMember(

...
class UserServiceTest {
  ...
  public void testUploadUserCSV() throws IOException {
    ...
    Mockito
      .when(userRepository.findOneByEmailIgnoreCase(Mockito.eq("user2@orcid.org")))
  ...
  public void testUpdateMemberNames_fullPage() {
    Mockito
      .when(userRepository.findByMemberName(Mockito.any(Pageable.class), Mockito.isNull()))
  ...
  public void testGetAllUsersBySalesforceId() {
    Mockito
      .when(userRepository.findBySalesforceIdAndDeletedIsFalse(Mockito.any(Pageable.class), Mockito.anyString()))
      .thenReturn(new PageImpl<>(getListOfUsers(10)));
    Mockito
      .when(
  ...
  void testUpdateUsersSalesforceId() {
    ...
    Mockito
      .when(userRepository.findBySalesforceIdAndDeletedIsFalse(Mockito.any(Pageable.class), Mockito.eq("salesforce-id")))
  ...
  void testUpdateUsersSalesforceIdWithFailure() {
    ...
    Mockito
      .when(userRepository.findBySalesforceIdAndDeletedIsFalse(Mockito.any(Pageable.class), Mockito.eq("new-salesforce-id")))
      .thenReturn(new PageImpl<User>(Arrays.asList(new User(), new User(), new User())))
      .thenReturn(new PageImpl<User>(new ArrayList<>()));

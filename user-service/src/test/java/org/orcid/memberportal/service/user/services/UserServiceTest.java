...
class UserServiceTest {
      ...
      public void setUp() {
            ...
            SecurityContextHolder.setContext(
                  new MockSecurityContext("username")
            );
      }
      ...
      void testResendActivationEmail() {
            ...
            user.setResetDate(
                  Instant
                        .now()
                        .minusSeconds(
                              UserService.RESET_KEY_LIFESPAN_IN_SECONDS + 10000
                        )
            );
            Mockito
      ...
      public void testExpiredResetKey() {
            ...
            user.setResetDate(
                  Instant
                        .now()
                        .minusSeconds(
                              UserService.RESET_KEY_LIFESPAN_IN_SECONDS - 2000
                        )
            );
            Mockito
      ...
      public void testEnableMfa() {
            ...
            backupCodes.forEach(c -> {
                  assertThat(c.length())
                        .isEqualTo(UserService.BACKUP_CODE_LENGTH); // check
                  // code
                  // has
                  // not
                  // been
      ...
      private User getUserUsingMfa() {
            ...
            user.setMfaBackupCodes(
                  Arrays.asList("backup1", "backup2", "backupn")
            );
            return user;
      }

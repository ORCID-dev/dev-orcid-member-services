...
public class UserResourceIT {
  ...
  public void createUser() throws Exception {
    ...
    restUserMockMvc
      .perform(post("/api/users").contentType(TestUtil.APPLICATION_JSON_UTF8).content(TestUtil.convertObjectToJsonBytes(managedUserVM)))
  ...
  public void getUser() throws Exception {
    ...
    MvcResult result = restUserMockMvc
      .perform(get("/api/users/{login}/", user.getEmail()))
      .andExpect(status().isOk())
      .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
  ...
  public void updateUser() throws Exception {
    ...
    restUserMockMvc
      .perform(put("/api/users").contentType(TestUtil.APPLICATION_JSON_UTF8).content(TestUtil.convertObjectToJsonBytes(managedUserVM)))
      .andExpect(status().isOk());
  ...
  public void getUsersBySalesforceId() throws Exception {
    ...
    MvcResult result = restUserMockMvc
      .perform(
        get("/api/users/salesforce/salesforce-id-1/p").accept(TestUtil.APPLICATION_JSON_UTF8).contentType(TestUtil.APPLICATION_JSON_UTF8)
      )
      .andExpect(status().isOk())
      .andReturn();
    ...
    result =
      restUserMockMvc
        .perform(
          get("/api/users/salesforce/incorrect-salesforce-id/p")
    ...
    result =
      restUserMockMvc
        .perform(
          get("/api/users/salesforce/salesforce-id-1/p")
    ...
    result =
      restUserMockMvc
        .perform(
          get("/api/users/salesforce/salesforce-id-1/p")
            .param("filter", "4@salesforce-id-1.org")
            .accept(TestUtil.APPLICATION_JSON_UTF8)
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
        )
        .andExpect(status().isOk())
    ...
    result =
      restUserMockMvc
        .perform(
          get("/api/users/salesforce/salesforce-id-1/p")
            .param("filter", "lastname+10%2Btest")
            .accept(TestUtil.APPLICATION_JSON_UTF8)
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
        )
        .andExpect(status().isOk())
    ...
    result =
      restUserMockMvc
        .perform(
          get("/api/users/salesforce/salesforce-id-5/p")
            .param("filter", "4@orcid.org")
            .accept(TestUtil.APPLICATION_JSON_UTF8)
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
        )
        .andExpect(status().isOk())
  ...
  public void getAllUsersWithFilter() throws Exception {
    ...
    result =
      restUserMockMvc
        .perform(
          get("/api/users").param("filter", "lastname 2").accept(TestUtil.APPLICATION_JSON_UTF8).contentType(TestUtil.APPLICATION_JSON_UTF8)
        )
        .andExpect(status().isOk())
        .andReturn();
    users = objectMapper.readValue(result.getResponse().getContentAsByteArray(), new TypeReference<List<UserDTO>>() {});
    ...
    result =
      restUserMockMvc
        .perform(
          get("/api/users").param("filter", "%2B").accept(TestUtil.APPLICATION_JSON_UTF8).contentType(TestUtil.APPLICATION_JSON_UTF8)
        )
        .andExpect(status().isOk())
        .andReturn();
    users = objectMapper.readValue(result.getResponse().getContentAsByteArray(), new TypeReference<List<UserDTO>>() {});
    ...
    result =
      restUserMockMvc
        .perform(
          get("/api/users")
            .param("filter", "10%2Btest@salesforce-id-1.org")
            .accept(TestUtil.APPLICATION_JSON_UTF8)
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
        )
        .andExpect(status().isOk())

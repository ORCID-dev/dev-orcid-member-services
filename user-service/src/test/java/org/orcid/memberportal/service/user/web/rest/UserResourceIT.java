...
public class UserResourceIT {
      ...
      private static final String UPDATED_IMAGEURL =
      ...
      public void setup() {
            ...
            MemberService mockedMemberService = Mockito.mock(
                  MemberService.class
            );
            Mockito
                  .when(
                        mockedMemberService.memberExistsWithSalesforceId(
                              Mockito.anyString()
                        )
                  )
            ...
            Mockito
                  .when(
                        mockedMemberService.memberExistsWithSalesforceIdAndSuperadminEnabled(
                              Mockito.anyString()
                        )
                  )
            ...
            Mockito
                  .when(
                        mockedMemberService.getMemberNameBySalesforce(
            ...
            Mockito
                  .when(
                        mockedMemberService.getMemberNameBySalesforce(
                              Mockito.eq(UPDATED_SALESFORCE_ID)
                        )
                  )
      ...
      public void createUser() throws Exception {
            ...
            assertThat(testUser.getSalesforceId())
                  .isEqualTo(DEFAULT_SALESFORCE_ID);
      ...
      public void getUser() throws Exception {
            ...
            UserDTO read = objectMapper.readValue(
      ...
      public void updateUser() throws Exception {
            ...
            managedUserVM.setLastModifiedDate(
            ...
            assertThat(testUser.getSalesforceId())
                  .isEqualTo(UPDATED_SALESFORCE_ID);
      ...
      public void getUsersBySalesforceId() throws Exception {
            ...
            result =
                  restUserMockMvc
                        .perform(
                              get(
                                    "/api/users/salesforce/incorrect-salesforce-id/p"
                              )
                                    .accept(TestUtil.APPLICATION_JSON_UTF8)
                                    .contentType(TestUtil.APPLICATION_JSON_UTF8)
                        )
      ...
      private void saveTenUsersWithSalesforceId(String salesforceId) {
            for (int i = 0; i < 9; i++) {
                  userRepository.save(
                        createUser(String.valueOf(i), salesforceId)
                  );
            }
      ...
      @WithMockUser(
            username = LOGGED_IN_EMAIL,
            authorities = { "ROLE_ADMIN", "ROLE_USR" },
            password = LOGGED_IN_PASSWORD
      )
